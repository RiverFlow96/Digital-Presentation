// Archivo principal de la UI: componente App
// - Importa estilos globales
// - Composición de componentes: `Image` y `Information` reciben la prop `user`
//   con el nombre del usuario de GitHub que queremos mostrar.
...
function App() {
  ...
  return (
    // Contenedor principal de la tarjeta del perfil
    <div className='w-[30dvw] h-[85vh] flex-col bg-black rounded-2xl shadow-md shadow-black flex items-end'>
      ...
      <div className='flex w-full h-[80%] bg-white flex-col rounded-2xl p-4'>
        {/* Pasamos el nombre de usuario a los componentes para que hagan las peticiones a GitHub */}
